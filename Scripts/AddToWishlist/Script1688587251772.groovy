...
WebUI.click(findTestObject('Object Repository/Page_Customer Login/a_Sign In'))
...
WebUI.click(findTestObject('Object Repository/Page_My Wish List/div_Tiberius Gym Tank has been added to you_ad6e0c'))
